...
// 롱테일 키워드분석은 "씨드 키워드 등록·확장 → 분석 결과 확인" 순서로 진행하는 단계형
// 흐름이라, 사이드바도 그 순서를 그대로 위→아래 스텝퍼로 보여준다. 설정은 이 흐름의
// 일부가 아니라 별도 유틸리티라 분리.
const FLOW_STEPS = [
  {
    step: 1,
  ...
  },
  {
    ...
    icon: "📊",
    label: "롱테일 키워드 분석",
    description: "실행한 확장 결과를 최신순으로 확인",
  },
];
    ...
    <aside className="flex w-full flex-col border-b border-neutral-200 bg-white p-4 md:h-full md:w-64 md:justify-between md:border-b-0 md:border-r">
      <div>
        <div className="mb-4 md:mb-6">
          <div className="px-2 text-lg font-semibold text-neutral-900">롱테일 키워드분석</div>
          <a
