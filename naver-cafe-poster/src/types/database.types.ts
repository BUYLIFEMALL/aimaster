  ...
  public: {
    Tables: {
      ...
      kakao_broadcast_recipients: {
        ...
        Relationships: [
          {
            foreignKeyName: "kakao_broadcast_recipients_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "kakao_broadcast_groups"
            referencedColumns: ["id"]
          },
        ]
      }
      kakao_broadcast_send_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "kakao_broadcast_send_log_recipient_id_fkey"
            columns: ["recipient_id"]
            isOneToOne: false
            referencedRelation: "kakao_broadcast_recipients"
            referencedColumns: ["id"]
          },
        ]
      }
      kakao_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "kakao_reports_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "kakao_topics"
            referencedColumns: ["id"]
          },
        ]
      }
        ...
        Relationships: [
          {
            ...
            columns: ["target_id"]
            isOneToOne: false
            referencedRelation: "ncafe_targets"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      web_crawler_domain_profiles: {
        Row: {
          ...
          last_used_at: string
          needs_dynamic: boolean
          next_page_selector: string | null
          target_fields_key: string
        }
        Insert: {
          created_at?: string
          domain: string
