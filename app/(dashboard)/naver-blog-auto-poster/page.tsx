...
import { KeyRound, Download, Chrome, ListChecks } from "lucide-react";
...
const EXTENSION_DOWNLOAD_URL = `${RELEASE_BASE}/AIMaster-Naver-Blog-Auto-Poster-Extension-0.1.0.zip`;
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <GlassCard>
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-lg font-bold text-white">웹버전(크롬 확장) 다운로드</h2>
          </div>
          <p className="text-xs text-subtext mb-4">
          ...
          <a href={EXTENSION_DOWNLOAD_URL}>
            <GoldButton type="button">웹버전 다운로드 (.zip)</GoldButton>
          </a>
        </GlassCard>
        ...
        <GlassCard>
          ...
          <ol className="space-y-3 text-sm text-subtext list-decimal list-inside">
            ...
            <li>
              <span className="text-white">위에서 원하는 버전 다운로드</span> — 익숙한 별도
              프로그램이 편하면 데스크톱 앱, 브라우저 안에서 바로 쓰고 싶으면 웹버전(크롬
              확장)을 받으세요. 둘 다 써봐도 됩니다.
            </li>
            <li>
              <span className="text-white">설치</span> — 데스크톱 앱은 exe 파일을 더블클릭만
              하면 되고, 웹버전은 zip 압축을 푼 뒤 동봉된 설치방법.txt를 따라 크롬에
              &quot;압축해제된 확장 프로그램&quot;으로 로드하세요.
            </li>
            <li>
              <span className="text-white">계정 연동</span> — 아래 &quot;기기 연동 토큰&quot;에서
              토큰을 발급받아, 실행한 앱(또는 확장 사이드패널)의 &quot;AIMaster 계정
              연동&quot; 화면에 붙여넣으세요.
            </li>
            <li>
              <span className="text-white">네이버 로그인</span> — &quot;네이버 세션 확인&quot;을
              누르면 브라우저 창이 뜹니다(웹버전은 이미 로그인된 크롬을 그대로 씀). 아이디/
              비밀번호는 이 프로그램에 입력하지 않고, 그 창에서 본인이 직접 로그인하세요.
            </li>
            <li>
            ...
            <li>
              ...
              사람처럼 화면에 채워집니다. (웹버전에서 이미지를 생성했다면 클립보드에 복사되니,
              본문을 클릭한 뒤 Ctrl+V로 붙여넣으세요.)
            </li>
            <li>
