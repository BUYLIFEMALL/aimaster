...
export const metadata: Metadata = {
  ...
  description: "AI 마케팅 프로그램으로 시간을 절약하고 매출을 극대화하세요. SNS 자동화, 키워드 분석 등 검증된 도구를 제공합니다.",
  openGraph: {
    title: "AI Master — AI 마케팅 자동화 프로그램",
    description: "AI 마케팅 프로그램으로 시간을 절약하고 매출을 극대화하세요.",
  },
};
...
const NOTICE_ITEMS: NoticeItem[] = [
  ...
  {
    text: "사용자별로 생성된 데이터는 본인만 볼 수 있으며, 보안이 적용된 서버에 개인별 분리되어 저장됩니다.",
    highlights: [],
  },
  {
    text: "본 서비스는 프로그램 안정화를 위해 현재 베타(무료)로 서비스 중이며, 사용자 트래픽 및 서버 사용량 증가 시 일부 서비스는 유료로 전환될 예정임을 사전 공지드립니다.",
...
export default async function HomePage() {
  ...
  return (
    <div className="overflow-hidden">
      {/* Hero */}
      <section className="relative min-h-[55vh] flex items-center justify-center px-4 pt-24 pb-0">
        {/* Background glow */}
