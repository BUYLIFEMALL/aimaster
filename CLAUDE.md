...
- **2026-09-25 최근 작업 업데이트**:
  ...
  - `ai-image-studio` 서브프로젝트에 make.com Nanobanana 극사실적(photorealistic) 프롬프트 마스터 생성 엔진 적용 및 픽사 3D, 지브리 애니, 일본 2D 극장판 애니 스타일 신규 추가 및 카테고리별 10개 프롬프트 데이터셋 갱신 (`docs/PLATFORM_PATTERNS.md` §22, §23).
