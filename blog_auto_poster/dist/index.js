...
async function main() {
    ...
    try {
        ...
        const newsData = await (0, collector_1.collect24HourNews)(topic);
        ...
        const postData = await (0, generator_1.generateSeoPost)(newsData, { topic });
        ...
        const { postId, postUrl } = await (0, db_1.savePostToDatabase)(postData, newsData);
        console.log('\n============================================================');
