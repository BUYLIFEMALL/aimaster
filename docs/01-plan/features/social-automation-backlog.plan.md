...
| 기능 | 필요 권한 | 상태 |
|---|---|---|
| **DM 자동응답 챗봇** | `instagram_business_manage_messages` | 🚧 진행 중(`instagram-dm-reply` 서브프로젝트, 2026-08-26 착수 — 배포·계정 연결·웹훅 등록·가짜 이벤트 테스트까지 전부 완료. 실제 DM 왕복 테스트 + Cron 활성화만 남음) |
