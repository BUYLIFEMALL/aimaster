...
- **Ideogram (Typo & Text Special)**: `ideogram-ai/ideogram-v3-turbo`, `ideogram-ai/ideogram-v2-turbo`, `ideogram-ai/ideogram-v2` (Replicate OpenAPI 스키마 직대조 완료, 오타 극복 타이포그래피 특화, `style_type`, `magic_prompt_option` 제어, 실측 HTTP 201 Created 검수 완료).
