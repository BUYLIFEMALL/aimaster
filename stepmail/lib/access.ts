...
const THIS_PROGRAM_SLUG = "stepmail";
...
/**
 * 로그인 + "stepmail" 프로그램 이용 권한을 함께 확인한다.
...
/**
 * 실제 발송(SMTP)처럼 비용/평판 영향이 있는 동작 1건을 usage_logs에 기록한다.
