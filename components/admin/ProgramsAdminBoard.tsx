...
import { Pencil, Eye, EyeOff, ExternalLink, CheckSquare, Square, ArrowUp, ArrowDown, Settings, Check, X, Trash2, Plus } from "lucide-react";
...
export default function ProgramsAdminBoard({ programs: initialPrograms, categories: initialCategories, grades }: ProgramsAdminBoardProps) {
  ...
  return (
    <div>
      ...
      {showCategoryManager && (
        <div className="mb-5 rounded-xl border border-white/10 bg-white/5 p-4 space-y-2">
          {sortedCategoriesForGrouping.map((cat) => (
