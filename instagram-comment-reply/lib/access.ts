...
> {
  ...
  return { allowed: false, error: "인스타그램 댓글자동화 이용 권한이 없습니다. 구독 후 이용해주세요.", status: 403 };
}
