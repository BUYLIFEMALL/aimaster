  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm text-center">
      ...
      <a
        ...
        className="inline-block w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 px-4 rounded-xl transition-all"
      >
        AIMaster 회원가입 하러가기
      </a>
