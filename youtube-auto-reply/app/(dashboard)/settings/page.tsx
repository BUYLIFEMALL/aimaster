...
// app/(main)/guides의 platform_guides.id — 이 프로그램이 실제로 쓰는 API/플랫폼(구글 OAuth·
// OpenAI·Anthropic·Gemini·텔레그램 봇)에 해당하는 매뉴얼만 골랐다(2026-09-13).
const GUIDE_LINKS: { guideId: string; label: string }[] = [
  { guideId: "523e7401-7393-44f5-ba45-dd437e10fa2d", label: "Google OAuth 클라이언트 만들기 (Gmail·Drive 등)" },
