...
export const AI_MODEL_OPTIONS: AIModelOption[] = [
  ...
  { value: "gpt-4o-mini", label: "⚙️ GPT-4o-mini (경량 모델)", shortLabel: "GPT-4o-mini", provider: "openai" },
  { value: "o3-mini", label: "🧩 o3-mini (고성능 논리 추론 모델)", shortLabel: "o3-mini", provider: "openai" },

  // Google Gemini 2026 최신 라인업
  ...
  { value: "gemini-2.5-pro", label: "🎯 Gemini 2.5 Pro (고성능 깊이 있는 추론)", shortLabel: "Gemini 2.5 Pro", provider: "gemini" },
  ...
  { value: "gemini-1.5-flash", label: "⚙️ Gemini 1.5 Flash (이전 세대)", shortLabel: "Gemini 1.5 Flash", provider: "gemini" },

  // Anthropic Claude 2026 최신 라인업
  ...
  { value: "claude-3-5-sonnet-20241022", label: "⚙️ Claude 3.5 Sonnet (이전 세대)", shortLabel: "Claude 3.5 Sonnet", provider: "anthropic" },
];
