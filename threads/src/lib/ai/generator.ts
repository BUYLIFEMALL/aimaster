...
3. 본문(제목 제외)은 공백 포함 450자를 절대 넘기지 마세요
4. 문단을 나누어 간결하게 작성해서 읽기 쉽게 핵심 정보만 포함하고, 불필요한 설명은 하지 마세요
...
8. 홍보 링크(CTA)가 주어지면 게시글 맨 마지막 줄에 "CTA 문구 + 링크" 형태로 자연스럽게 추가하세요 (예: "👉 {문구}\n{링크}"). 450자 제한에 포함되니 본문 분량을 그만큼 줄여서 넣으세요
