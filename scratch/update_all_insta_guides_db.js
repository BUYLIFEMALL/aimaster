...
// 1. 자동포스팅 매뉴얼 HTML
const autoPostingHtml = `<p class="mb-4 text-base font-medium text-neutral-300">
...
<div class="mb-6 p-4 rounded-xl bg-amber-500/10 border border-amber-500/30">
  <p class="text-amber-400 font-semibold mb-1">📌 Meta 앱 ID 명칭 및 찾기 팁!</p>
  <p class="text-sm text-neutral-300">
    Meta 개발자 센터 <strong>[이용 사례 > 맞춤 설정 > Instagram API]</strong> 화면 상단에 표시된 
    <strong class="text-amber-300">Instagram 앱 ID</strong> 및 <strong class="text-amber-300">Instagram 앱 시크릿 코드</strong>를 복사해서 등록해주시면 됩니다.
  </p>
</div>
...
<h3 class="text-lg font-bold text-white mt-6 mb-3">2단계: Instagram 앱 ID &amp; Instagram 앱 시크릿 코드 확인 및 필수 권한 추가</h3>
<ol class="list-decimal list-inside space-y-2 mb-3 text-neutral-300">
  <li>앱 대시보드 ➔ 왼쪽 메뉴 <strong>[이용 사례] ➔ [맞춤 설정] ➔ [Instagram API]</strong> 선택</li>
  <li>화면 상단에 있는 <strong>Instagram 앱 ID</strong>와 <strong>Instagram 앱 시크릿 코드</strong>를 복사하여 서비스 설정 페이지에 입력합니다.</li>
  <li><strong>[권한 및 기능]</strong> 탭에서 아래 자동 포스팅 필수 권한들을 추가합니다:</li>
</ol>
...
<ol class="list-decimal list-inside space-y-2 mb-6 text-neutral-300">
  ...
  <li><strong>[Instagram 앱 ID]</strong> 및 <strong>[Instagram 앱 시크릿 코드]</strong> 등록 후 <strong>[Facebook으로 로그인]</strong> 클릭</li>
...
<div class="mt-8 p-4 rounded-xl bg-neutral-800/80 border border-neutral-700">
  ...
  <ul class="list-disc list-inside space-y-1 text-sm text-neutral-300">
    <li><strong>앱 ID 명칭</strong>: 메인 대시보드 상단 또는 <code class="text-sky-300">Instagram API > 맞춤 설정</code> 화면의 <code class="text-sky-300">Instagram 앱 ID</code> 및 <code class="text-sky-300">Instagram 앱 시크릿 코드</code>를 사용합니다.</li>
    <li><strong>OAuth URL</strong>: OAuth 리디렉션 URI에 <code class="text-sky-300">https://insta-auto-poster-red.vercel.app/api/instagram/callback</code> 등록</li>
    <li><strong>테스터 승인</strong>: <strong>Instagram 테스터</strong> 추가 ➔ 스마트폰 인스타 앱에서 초대 승인</li>
  </ul>
</div>`;

// 2. 댓글 및 DM 자동화 매뉴얼 HTML
const dmReplyHtml = `<p class="mb-4 text-base font-medium text-neutral-300">
...
<h3 class="text-lg font-bold text-white mt-6 mb-3">1단계: Meta 개발자 센터에서 Instagram API 추가 및 키 확인</h3>
<ol class="list-decimal list-inside space-y-2 mb-6 text-neutral-300">
  <li><a href="https://developers.facebook.com/" target="_blank" class="text-sky-400 underline">Meta Developer Portal</a> 접속 ➔ 로그인 ➔ <strong>[내 앱]</strong> 클릭 ➔ 대상 앱 선택</li>
  <li>왼쪽 메뉴 ➔ <strong>[이용 사례] ➔ [맞춤 설정] ➔ [Instagram API]</strong> 선택</li>
  <li>화면 상단에 노출되는 <strong>Instagram 앱 ID</strong>와 <strong>Instagram 앱 시크릿 코드</strong>를 복사하여 프로그램 설정에 입력합니다.</li>
</ol>
...
<ul class="list-disc list-inside space-y-1 mb-6 pl-4 text-neutral-300">
  ...
  <li>🟢 <code>instagram_business_manage_comments</code> (⭐ <strong>댓글 관리 핵심 권한!</strong>)</li>
</ul>
...
<ol class="list-decimal list-inside space-y-2 mb-6 text-neutral-300">
  ...
  <li><strong>웹훅 필드 구독</strong>: 저장 후 아래 나타나는 Webhook 필드 목록에서 <code>messages</code> (DM 메시지 수신) 및 <code>comments</code> (댓글 수신) 항목 우측의 <strong>[구독 (Subscribe)]</strong> 버튼을 클릭합니다.</li>
</ol>

<h3 class="text-lg font-bold text-white mt-6 mb-3">5단계: 내 계정을 테스터(Tester)로 등록 (앱 검수 없이 바로 쓰기!)</h3>
<p class="mb-3 text-neutral-300">💡 Meta의 앱 검수(App Review) 절차 없이 본인 인스타 계정에서 즉시 DM 및 댓글 자동화를 쓰기 위한 필수 단계입니다.</p>
<ol class="list-decimal list-inside space-y-2 mb-6 text-neutral-300">
...
<ol class="list-decimal list-inside space-y-2 mb-6 text-neutral-300">
  <li><strong>[Instagram DM Reply / 댓글 Reply 웹사이트]</strong> 접속 ➔ 로그인</li>
  <li><strong>[Instagram 앱 ID]</strong> 및 <strong>[Instagram 앱 시크릿 코드]</strong> 입력 후 <strong>[인스타그램 계정 연결]</strong> 클릭 ➔ 권한 승인 완료</li>
  <li>설정 메뉴 ➔ <strong>DM 봇 / 댓글 봇 활성화</strong> 스위치를 <strong>ON(파란색)</strong>으로 켜면 완성입니다! 🎉</li>
</ol>
...
<div class="mt-8 p-4 rounded-xl bg-neutral-800/80 border border-neutral-700">
  ...
  <ul class="list-disc list-inside space-y-1 text-sm text-neutral-300">
    ...
    <li><strong>4단계</strong>: Webhooks 콜백 URL 및 토큰 입력 ➔ <code>messages</code> 및 <code>comments</code> 구독</li>
    <li><strong>5단계</strong>: <strong>Instagram 테스터</strong>에 내 인스타 아이디 추가 ➔ 인스타 앱에서 테스터 승인</li>
  </ul>
</div>`;

async function updateAllInstaGuides() {
  // Update Auto Posting Guide
  const res1 = await fetch(`${SUPABASE_URL}/rest/v1/platform_guides?id=eq.6cdae259-b9d2-45ae-9c21-e5f498f78956`, {
    method: 'PATCH',
    headers: {
      'apikey': SERVICE_KEY,
    ...
    body: JSON.stringify({ content: autoPostingHtml, updated_at: new Date().toISOString() })
  });
  console.log('Updated Auto Posting Guide:', res1.ok);

  // Update DM/Comment Reply Guide
  const res2 = await fetch(`${SUPABASE_URL}/rest/v1/platform_guides?id=eq.4115e455-1585-4304-89b4-d29859fd7a5a`, {
    method: 'PATCH',
    headers: {
      'apikey': SERVICE_KEY,
      'Authorization': `Bearer ${SERVICE_KEY}`,
    ...
    body: JSON.stringify({ content: dmReplyHtml, updated_at: new Date().toISOString() })
  });
  console.log('Updated DM Reply Guide:', res2.ok);
}

updateAllInstaGuides();
