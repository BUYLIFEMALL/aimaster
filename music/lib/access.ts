...
// 이 앱(music)은 AIMaster와 같은 Supabase 프로젝트를 공유한다.
...
const THIS_PROGRAM_SLUG = "music-automation";
...
/**
 * 로그인 + "music-automation" 프로그램 이용 권한을 함께 확인한다.
...
> {
  ...
  return { allowed: false, error: "음악(SUNO)자동화 이용 권한이 없습니다. 구독 후 이용해주세요.", status: 403 };
}
