...
//
// GPT-5.6 계열(현재 OpenAI 공식 카탈로그)을 맨 앞에 두고, 이전에 쓰던 구형 모델도
// 선택지로 남겨뒀다. 단, gpt-4o-mini/gpt-4o/o3-mini/o3는 2026-08-10 기준 OpenAI
// 공식 문서 카탈로그에는 더 이상 나오지 않아 단종되었을 수 있다 — 실제로 호출 시
// 에러가 날 수 있으니 그 경우 위쪽 GPT-5.6 계열로 다시 시도할 것.
...
export const ANALYSIS_MODEL_OPTIONS: { value: AnalysisModel; label: string }[] = [
  ...
  { value: "o3-mini", label: "o3-mini (가성비)" },
