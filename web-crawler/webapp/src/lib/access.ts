...
// 이 앱(web-crawler-saas)은 AIMaster와 같은 Supabase 프로젝트를 공유한다.
...
const THIS_PROGRAM_SLUG = "web-crawler-saas";
...
> {
  ...
  return { allowed: false, error: "웹 크롤링 자동화 이용 권한이 없습니다. 구독 후 이용해주세요.", status: 403 };
}
