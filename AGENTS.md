...
- 2026-09-25: 관리자 프롬프트 추천 게시판(`admin/prompts`)의 프로그램 전환 시 카테고리 연동 & 자동 리셋 필터 적용. `ai-image-studio`에 make.com Nanobanana 극사실적 포토리얼리즘 프롬프트 엔진 및 10종 화풍 샘플 데이터 적용 (`docs/PLATFORM_PATTERNS.md` §22 참고).
