...
| 5 | 도매매(dome.co.kr) Open API를 `/sourcing`에 알리익스프레스와 나란히 추가 — 국내 위탁소싱이라 관세/부가세/해외운송비 계산 불필요, 개인 ID 로그인만으로 API Key 즉시 무료 발급 가능해 BYOK 원칙에 가장 적합 | ⏸️ **대기 1순위**(2026-09-01 조사 결과로 큐 등록, 착수 전 사용자 승인 필요) |
