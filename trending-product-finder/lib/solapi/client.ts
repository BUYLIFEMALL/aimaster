...
// SOLAPI 공식 Node.js SDK(solapi 패키지)를 감싼 얇은 래퍼 — crm-google-form/lib/solapi/client.ts와
// 동일한 코드를 그대로 재사용한다. HMAC-SHA256 서명/인증은 SDK가 전부 처리한다(직접 구현하지
// 않음, https://solapi.com/developers 참고).
//
